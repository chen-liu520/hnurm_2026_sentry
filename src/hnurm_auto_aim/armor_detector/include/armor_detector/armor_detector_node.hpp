...
private:
  ...
  // void targetCallback(const hnurm_interfaces::msg::Target::SharedPtr
  // target_msg);
  ...
  hnurm_interfaces::msg::Armors armors_msg_;
  rclcpp::Publisher<hnurm_interfaces::msg::Armors>::SharedPtr armors_pub_;
  ...
  // hnurm_interfaces::msg::Target::SharedPtr tracked_target_;
  ...
  rclcpp::Publisher<hnurm_interfaces::msg::DebugLights>::SharedPtr
      lights_data_pub_;
  rclcpp::Publisher<hnurm_interfaces::msg::DebugArmors>::SharedPtr
      armors_data_pub_;
