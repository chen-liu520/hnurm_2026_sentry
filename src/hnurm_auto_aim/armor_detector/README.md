...
*  `armor_detector/armors` (`hnurm_interfaces/msg/Armors`) - 识别到的装甲板信息
*  `armor_detector/debug_lights` (`hnurm_interfaces/msg/DebugLights`) - Debug灯条信息
*  `armor_detector/debug_armors` (`hnurm_interfaces/msg/DebugArmors`) - Debug装甲板信息
...
*  `armor_detector/set_mode` (`hnurm_interfaces/srv/SetMode`) - 设置模式
