# hnurm_robot_description
RoboMaster 视觉自瞄系统所需的 URDF

<img src="docs/hnurm_vision.svg" alt="hnurm_vision" width="200" height="200">

该项目为 [hnurm_vision](https://github.com/chenjunnn/hnurm_vision) 的子模块
...
修改 [urdf/hnurm_gimbal.urdf.xacro](urdf/hnurm_gimbal.urdf.xacro) 中的 `gimbal_camera_transfrom` 
