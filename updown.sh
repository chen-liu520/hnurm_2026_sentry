...
cmds=( 
    ...
    "ros2 launch hnurm_decision_upanddown params_visualizer.launch.py"
    #relocaliztion
...
while [ 1 ]; do
    ...
    if [ "${tcount}" -ge 1 ]; then
        ...
        ros2 run hnurm_decision_upanddown decision_node --ros-args --params-file ${SCRIPT_DIR}/src/hnurm_updown_decison/src/hnurm_decision_upanddown/param/params.yaml; \
        exec bash"
